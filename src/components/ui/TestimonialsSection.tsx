...
const allReviews = [
  ...
  { name: "Zeynep K.", title: "Android Geliştiricisi", text: "Arkadaş bulamıyordum, 16 gün boyunca test edecek kimse yoktu. Burada 18 kişi birbirine destek oluyor." },
  ...
  { name: "Burak K.", title: "Startup Kurucusu", text: "Şirket uygulamamız için 18 testçi bulmak imkansızdı. PremiumPeek ile 1 günde çözdük." },
  { name: "Hande Y.", title: "Android Geliştiricisi", text: "Aksatma halinde atılma kuralı sayesinde herkes aktif. Diğer platformlarda testçiler kaybolup gidiyordu." },
  ...
  { name: "Berke T.", title: "Android Geliştiricisi", text: "Pack sistemindeki aksatma kuralı çok iyi düşünülmüş. Kimse kaytaramıyor." },
