    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
      ...
      <div className="rounded-2xl bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 p-6 mb-8">
        <p className="text-green-700 dark:text-green-400 font-medium">
          ...
          Hiçbir soru sorulmaz, hiçbir şart aranmaz.
        </p>
      </div>
      ...
      <div className="space-y-8 mb-8">
        <section>
          ...
          <ul className="space-y-3">
            {[
              "Profesyonel test hizmeti satın alan tüm kullanıcılar için geçerlidir.",
              "Google Play üretim erişim başvurusu reddedildikten sonra 30 gün içinde talep edilmelidir.",
              "Red sebebi, test süreciyle ilgili olmalıdır (paket ismi hatası gibi teknik sebepler kapsam dışıdır).",
              "İade, ödemenin yapıldığı yönteme geri gönderilir. Para bankanıza bağlı olarak 5-10 iş günü içinde hesabınıza yansır.",
              "Her kullanıcı, her uygulama için bir kez iade hakkından yararlanabilir.",
              "İade edilen siparişlerin test süreci durdurulur ve raporlar geçersiz sayılır.",
            ].map((item, i) => (
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              { step: "1", title: "Red Bildirimi", desc: "Google Play Console'dan üretim erişim başvurunuzun reddedildiğine dair bildirimi alın." },
              { step: "2", title: "Talep Oluştur", desc: "Red ekran görüntüsü ve sipariş numaranızla birlikte info@premiumpeek.com adresine e-posta gönderin." },
              { step: "3", title: "Onay ve İade", desc: "Ekibimiz talebinizi 24 saat içinde inceler ve onaylar. İade, orijinal ödeme yönteminize yapılır." },
            ].map(item => (
        ...
        <section className="rounded-2xl bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 p-6">
          ...
          <p className="text-sm text-yellow-700 dark:text-yellow-400 leading-relaxed">
            ...
            Ancak olası bir red durumunda sizi korumak için buradayız. 
            Google Play politikaları değişirse iade şartları da güncellenebilir.
          </p>
        </section>
      </div>
    </div>
